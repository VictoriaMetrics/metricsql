...
func TestGetCommonLabelFilters(t *testing.T) {
	...
	f(`foo{a="x",instance="i"} * on(instance) group_left(*) bar`, `{instance="i"}`)
	f(`foo * on(instance) group_right(*) bar{a="x",instance="i"}`, `{instance="i"}`)
	f(`foo{a="x",p_b="old"} * on(instance) group_left(*) prefix "p_" bar`, `{a="x"}`)
	f(`foo * on(instance) group_right(*) prefix "p_" bar{a="x",p_b="old"}`, `{a="x"}`)
	f(`foo{a="x",p_a="old"} * on(instance) group_left(a) prefix "p_" bar`, `{}`)
	f(`foo * on(instance) group_right(a) prefix "p_" bar{a="x",p_a="old"}`, `{}`)
	f(`{a="b"} or {c="d"}`, `{}`)
...
func TestOptimize(t *testing.T) {
	...
	f(`(foo{a="x"} * on(instance) group_left(*) bar) and on(a) baz`, `(foo{a="x"} * on(instance) group_left(*) bar) and on(a) baz`)
	f(`(foo * on(instance) group_right(*) bar{a="x"}) and on(a) baz`, `(foo * on(instance) group_right(*) bar{a="x"}) and on(a) baz`)
